...
exports.convertToLogCompliantTenderlyConfig = exports.convertToLogCompliantForkInitializeResponse = exports.convertToLogCompliantNetworks = exports.convertToLogCompliantProjects = exports.convertToLogCompliantVerificationResponse = exports.convertToLogCompliantBytecodeMismatchErrors = exports.convertToLogCompliantContracts = exports.convertToLogCompliantForkVerificationResponse = exports.convertToLogCompliantApiError = void 0;
function convertToLogCompliantApiError(err) {
    // api error
    if ("response" in err) {
...
exports.convertToLogCompliantApiError = convertToLogCompliantApiError;
function convertToLogCompliantForkVerificationResponse(res) {
...
exports.convertToLogCompliantForkVerificationResponse = convertToLogCompliantForkVerificationResponse;
function convertToLogCompliantContracts(contracts) {
...
exports.convertToLogCompliantContracts = convertToLogCompliantContracts;
function convertToLogCompliantBytecodeMismatchErrors(bytecodeMismatchErrors) {
...
exports.convertToLogCompliantBytecodeMismatchErrors = convertToLogCompliantBytecodeMismatchErrors;
function convertToLogCompliantVerificationResponse(res) {
...
exports.convertToLogCompliantVerificationResponse = convertToLogCompliantVerificationResponse;
function convertToLogCompliantVerificationResults(results) {
...
function convertToLogCompliantCompilationErrors(compilationErrors) {
...
function convertToLogCompliantProjects(projects) {
...
exports.convertToLogCompliantProjects = convertToLogCompliantProjects;
function convertToLogCompliantNetworks(networks) {
...
exports.convertToLogCompliantNetworks = convertToLogCompliantNetworks;
function convertToLogCompliantForkInitializeResponse(res) {
    return {
...
exports.convertToLogCompliantForkInitializeResponse = convertToLogCompliantForkInitializeResponse;
function convertToLogCompliantTenderlyConfig(config) {
    return {
        email: config.email !== undefined && config.email !== null && config.email !== ""
            ? "set in 'email' field"
            : "undefined or null or empty string",
        account_id: config.account_id,
        username: config.username !== undefined && config.username !== null && config.username !== ""
            ? "set in 'username' field"
            : "undefined or null or empty string",
        access_key: config.access_key !== undefined && config.access_key !== null && config.access_key !== ""
            ? "super secret access_key is set in 'access_key' field"
            : "undefined or null or empty string",
        access_key_id: config.access_key_id !== undefined && config.access_key_id !== null && config.access_key_id !== ""
            ? "super secret access_key_id is set in 'access_key' field"
            : "undefined or null or empty string",
    };
}
exports.convertToLogCompliantTenderlyConfig = convertToLogCompliantTenderlyConfig;
//# sourceMappingURL=log-compliance.js.map